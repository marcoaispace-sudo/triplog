...
export default function Home(){
  ...
  const recognizeDocument=async(document:TripDocument)=>{
    ...
    setOcrDocument(document);setOcrBusy(true);setOcrProgress(0);setOcrStatus("準備下載私人相片…");setOcrFields({...emptyOcrFields,...document.ocr});setOcrRawText("");setOcrError("");setModal("ocr");
