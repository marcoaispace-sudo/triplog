...
function sharedLedgerPayload(trip:Trip){return {items:trip.requirements??[],expenses:trip.expenses??[],packingItems:trip.packingItems??packingTemplates(),accommodation:trip.sharedAccommodation,entryForm:trip.entryFormDetails}}
