...
export default function Home(){
  ...
  return <main className="app-shell"><div className="phone-app">
    ...
    {active==="首頁"&&<>
      ...
      <section className="day-section"><div className="section-heading day-heading"><div><p>第{homeDayNumber}日安排</p><h3>{activeTrip.destination}行程</h3></div><button className="recommend-button" onClick={()=>void openNearbyRecommendations()}><Icon name="pin" size={16}/>附近推介</button></div><Timeline items={homeDayItems} onMap={openMap} onDirections={openDirections}/></section>
    </>}
